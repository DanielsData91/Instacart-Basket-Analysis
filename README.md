...
Age classification: Observing the age group demographic reveals a clear relationship between age and income group due to the growing experience on the job, which comes along with a higher salary. Older adults have the strongest spending capacity among all age groups. Looking at the other variables like,  there seems to be no relationship between family status, order frequency, and region. 
